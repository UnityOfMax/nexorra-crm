...
const STAGES = [
  ...
  { key: 'dealsClosed' as const,    label: 'Deals Closed',          icon: Award,         color: 'from-rose-500 to-rose-600',    bg: 'bg-rose-50 dark:bg-rose-950/40',    text: 'text-rose-700 dark:text-rose-300',    border: 'border-rose-200 dark:border-rose-800/50' },
];
              ...
              <div className={`flex items-center gap-3 p-2.5 rounded-xl border ${stage.bg} ${stage.border}`}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-sm font-bold tabular-nums ${stage.text}`}>{value.toLocaleString()}</span>
                  </div>
