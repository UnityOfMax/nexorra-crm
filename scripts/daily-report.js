...
async function generateReport() {
  ...
  console.log(`- Total leads available: ${totalLeads}`)
  console.log(`- Leads processed today: ${scrapedCount}`)
  console.log(`- Conversations updated today: ${convCount}`)
}
