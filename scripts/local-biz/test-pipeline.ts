...
Generate one JSON object:
{
  ...
  "outreach_body_email": "Phrase 1 (intro): Hey, I'm Max — I came across A Hair Sensation while looking around Macon and decided to put a new website together for you (hope that's okay!)\\n\\nPhrase 2 (specific observation): [specific thing you noticed — no booking system, Times New Roman, 2005-era layout — be concrete and conversational]\\n\\nPhrase 3 (cost): [what that costs them in plain terms — 3-4 bookings a week phrasing]\\n\\nPhrase 4 (demo): Here's what I put together for you: {{DEMO_LINK}}\\n\\nPhrase 5 (price): I charge £450-950 for the site, just so it's not a shock if you do want to go ahead — but take a look first, no obligation.",
  ...
  try {
    ...
    return {
      ...
      outreach_body_email: "Hey, I'm Max — I came across A Hair Sensation while looking around Macon and decided to put a new website together for you (hope that's okay!)\n\nI noticed the site doesn't have any way to book online. It's still just a phone number, and the layout looks like it hasn't changed since about 2005.\n\nThat probably costs you 3-4 bookings a week. Someone visits, sees an old site with no way to book, and just tries the next one in Google.\n\nHere's what I put together for you: {{DEMO_LINK}}\n\nI charge £450-950 for the site, just so it's not a shock if you do want to go ahead — but take a look first, no obligation.",
